"""AgentCore Gateway & Identity Agent -- Versão V4 (Com Gateway MCP e JWT Forwarding)."""
...
SYSTEM_PROMPT = """\
You are Aria, a personal AI assistant connected to AgentCore Gateway and Task API.
"""
